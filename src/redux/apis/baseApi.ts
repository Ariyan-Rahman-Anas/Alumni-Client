...
export const baseApi = createApi({
    ...
    tagTypes: ["projects", "certificates", "experiences", "specalities", "skills", "educations", "batches", "users", "events", "imageCategories", "galleryImages", "announcements", "jobs", "jobApplications", "providers", "providerContacts"],
    endpoints: () => ({})
})