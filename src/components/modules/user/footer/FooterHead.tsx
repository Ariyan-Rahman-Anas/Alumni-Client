...
//     const { schoolName, facebook, youtube, whatsappNumber } = websiteManagement?.data || {}
...
//             {/* Tagline */}
//             <FadeUpWrapper
//                 className="inline-flex items-center gap-3 mt-2 px-5 py-2.5 rounded-full mx-auto"
//                 style={{
...
const FooterHead = () => {
    ...
    const { schoolName, facebook, youtube, whatsappNumber } =
    ...
    return (
        <div className="relative py-12 px-3 text-center">
            ...
            <FadeUpWrapper
                ...
                style={{
                    background:
                        "linear-gradient(160deg, #f0fdf4 20%, #86efac 60%, #d1fae5 90%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                    filter:
                        "drop-shadow(0 2px 16px rgba(46,139,87,0.4))",
                }}
            >
                <span className="text-xl">Alumni Association of</span>
                <br />
                {schoolName || "Battali Abdul Matin High School"}
            </FadeUpWrapper>
                        ...
                        <Link
                            ...
                            onMouseEnter={(e) => {
                                ...
                                e.currentTarget.style.boxShadow =
                                    "0 0 16px rgba(46,139,87,0.40), inset 0 1px 0 rgba(255,255,255,0.08)";
