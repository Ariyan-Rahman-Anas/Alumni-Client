...
//     if (event.status === "ONGOING" || (start <= now && new Date(event?.endDateTime) >= now)) {
...
//             <Link href={`/events/${event.slug}`} className="block group overflow-hidden shadow hover:shadow-lg transition-all duration-300 rounded-3xl">
//                 <div
...
//                                                 borderColor: "var(--color-primary2-200)",
//                                                 color: "var(--color-primary2-800)",
//                                             }}
//                                         >
...
//                 <div
//                     className="h-full rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group-hover:-translate-y-0.5 border"
//                     style={{
...
//                                 style={{ background: "linear-gradient(to top, rgba(10,61,43,0.6) 0%, transparent 60%)" }}
//                             />
//                         </div>
//                     )}
...
//                         {/* Title */}
//                         <h3
//                             className="font-display font-semibold text-base leading-snug mb-2 line-clamp-2 transition-colors duration-200 group-hover:text-primary"
...
//                                 {event.isFree ? "Free Entry" : event.priceTiers?.length ? `From ৳${Math.min(...event.priceTiers.map((t) => t.fee))}` : "Paid"}
//                             </span>
//                             <span
...
//                     {/* If only featured exists, also show message */}
...
//                     <Button
//                         asChild
//                         className="rounded-xl font-medium px-7 py-5 shadow-md hover:shadow-lg transition-shadow duration-200"
//                     >
//                         <Link href="/events">
