...
const HeroSection = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-primary2-900 dark:from-gunmetal-950 via-primary2-950/40 dark:via-gunmetal-950/40 to-primary2-950/40 dark:to-gunmetal-950/40 "/>
