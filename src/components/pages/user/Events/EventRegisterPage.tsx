...
function EventSummaryCard({ event, userBatch }: { event: IEvent; userBatch?: number }) {
    ...
    return (
        <div className="rounded-2xl border border-surface-200 bg-white p-5 space-y-3">
            ...
            {event.isFree && (
                <div className="pt-2 border-t border-surface-100 text-sm font-bold text-primary2-700">
                    Free Entry
                </div>
            )}
        </div>
    ...
    return (
        <div className={cn(
            ...
            isCancelled
                ...
                : "bg-primary2-50 border-primary2-200"
        )}>
            <RiCheckboxCircleLine className={cn("text-2xl flex-shrink-0 mt-0.5", isCancelled ? "text-red-500" : "text-primary2-600")} />
            <div>
                <p className={cn("font-semibold", isCancelled ? "text-red-700" : "text-primary2-700")}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 items-start">
                ...
                <div className="space-y-6">
                    ...
                    {!event.isRegistrationRequired && !blocker && (
                        <div className="rounded-2xl border border-primary2-200 bg-primary2-50 p-5 flex items-start gap-3">
                            <RiCheckboxCircleLine className="text-primary2-600 text-xl flex-shrink-0 mt-0.5" />
                            <div>
                                <p className="text-primary2-800 font-semibold">Open Entry</p>
                                <p className="text-primary2-700 text-sm mt-0.5">
