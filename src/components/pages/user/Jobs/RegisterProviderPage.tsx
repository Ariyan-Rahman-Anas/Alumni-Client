...
export default function RegisterProviderPage() {
    ...
    if (existingProfile) {
        ...
        const config = {
            ...
            APPROVED: {
                icon: <RiCheckboxCircleLine className="text-3xl text-primary2-500" />,
                ...
                bg: "bg-primary2-50 border-primary2-200",
                badge: "bg-primary2-100 text-primary2-700 border-primary2-300",
                badgeText: "Approved",
