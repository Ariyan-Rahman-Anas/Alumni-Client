// // ============================================================
// //  EVERGREEN ACADEMY — tailwind.config.js
// //  School Portal: present & ex-students, staff, public
...
//       // ── 2. TYPOGRAPHY ─────────────────────────────────────
//       // fontFamily: {
//       //   // Display: for headings, hero text, school name
//       //   display: ["Playfair Display", "Georgia", ...fontFamily.serif],
//       //   // Body: for paragraphs, UI copy
//       //   sans:    ["DM Sans", "Helvetica Neue", ...fontFamily.sans],
//       //   // Mono: for codes, IDs, roll numbers
//       //   mono:    ["JetBrains Mono", "Fira Code", ...fontFamily.mono],
//       //   // Serif: for formal notices, certificates
//       //   serif:   ["Lora", "Georgia", ...fontFamily.serif],
//       // },
...
// ============================================================
//  EVERGREEN ACADEMY — tailwind.config.js
//  Alumni Portal: BAMHSians worldwide
//  Theme: Forest Green + Warm Cream | Futuristic & Refined
// ============================================================
...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      // ── 1. COLORS ─────────────────────────────────────────
      colors: {
        // ── Shadcn token layer (required — do not remove) ───
        background:             "#FDFAF2",
        foreground:             "#141412",
        primary:                "#2E8B57",
        "primary-foreground":   "#FFFFFF",
        ...
        warning: { light: "#FEF9C3", DEFAULT: "#D97706", dark: "#92400E" },
      ...
      // ── 3. SPACING ────────────────────────────────────────
      spacing: {
        "4.5": "1.125rem", "5.5": "1.375rem",
        "13":  "3.25rem",  "15":  "3.75rem",
      ...
      keyframes: {
        ...
        pop:         { "0%": { transform: "scale(1)" }, "40%": { transform: "scale(1.15)" }, "100%": { transform: "scale(1)" } },
      },
      ...
      backdropBlur: {
        ...
        md: "12px", lg: "16px", xl: "24px", "2xl": "40px", "3xl": "64px",
      },
      ...
      screens: {
        ...
        lg: "1024px", xl: "1280px", "2xl": "1400px", "3xl": "1600px",
      },
      ...
      aspectRatio: {
        ...
        "1/1": "1 / 1", portrait: "3 / 4", card: "5 / 3", banner: "8 / 1",
      },
      ...
      ringOffsetColor: { light: "#FDFAF2", dark: "#0A3D2B" },


      // ── 13. OPACITY ───────────────────────────────────────
      opacity: {
        0: "0", 5: "0.05", 10: "0.10", 15: "0.15", 20: "0.20",
        25: "0.25", 30: "0.30", 40: "0.40", 50: "0.50",
        60: "0.60", 70: "0.70", 75: "0.75", 80: "0.80",
        90: "0.90", 95: "0.95", 100: "1",
      },
  ...
  plugins: [
    ...
    // ─────────────────────────────────────────────────────
    // FIX 3: The plugin callback parameters were implicitly
    // `any` because Tailwind's plugin type isn't inferred
    // from the `require()` call in a plain JS config file.
    //
    // Solution A (used here — works in both JS and TS):
    //   Wrap with `require('tailwindcss/plugin')` which
    //   gives the callback proper types automatically.
    //
    // Solution B (alternative if you rename to .ts):
    //   import plugin from 'tailwindcss/plugin'
    //   and use plugin(({ addUtilities, addComponents, theme }) => { ... })
    // ─────────────────────────────────────────────────────
    require("tailwindcss/plugin")(
      /**
       * @param {{ addUtilities: Function, addComponents: Function, theme: Function }} helpers
       */
      ({ addUtilities, addComponents, theme }: { addUtilities: Function, addComponents: Function, theme: Function }) => {
